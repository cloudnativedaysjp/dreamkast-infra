...
aws ecs describe-task-definition --task-definition dreamkast-dev-dk-2491-harvestjob &&   aws ecs deregister-task-definition --task-definition dreamkast-dev-dk-2491-harvestjob:1
