...
aws ecs describe-task-definition --task-definition dreamkast-dev-dk-2489-harvestjob &&   aws ecs deregister-task-definition --task-definition dreamkast-dev-dk-2489-harvestjob:1
