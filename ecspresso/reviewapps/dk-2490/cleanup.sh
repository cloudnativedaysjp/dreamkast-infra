...
aws events describe-rule --name dk-2490-harvestjob &&   aws events remove-targets --rule dk-2490-harvestjob --ids dk-2490-harvestjob &&   aws events delete-rule --name dk-2490-harvestjob --force
aws ecs describe-task-definition --task-definition dreamkast-dev-dk-2490-harvestjob &&   aws ecs deregister-task-definition --task-definition dreamkast-dev-dk-2490-harvestjob:1
